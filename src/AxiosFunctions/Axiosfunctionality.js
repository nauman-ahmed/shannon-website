...
export const getGraphicCovers = async (data) => {
    try {
        const response = await axios.get(BASE_URL + 'graphicNovel/getAllCovers', data);
        return response.data;
    } catch (error) {
        logouter();
    }
...
export const getGraphicSequential = async (data) => {
    try {
        const response = await axios.get(BASE_URL + 'graphicNovel/getAllSequential', data);
        return response.data;
    } catch (error) {
...
export const getGraphicInking = async (data) => {
    try {
        const response = await axios.get(BASE_URL + 'graphicNovel/getAllInking', data);
        return response.data;
    } catch (error) {
        console.log('ERROR IN FETCHING API')
    }
...
export const getGraphicColoring = async (data) => {
    try {
        const response = await axios.get(BASE_URL + 'graphicNovel/getAllColoring', data);
        return response.data;
    } catch (error) {
        console.log('ERROR IN FETCHING API')
    }
...
export const getGraphicLettering = async (data) => {
    try {
        const response = await axios.get(BASE_URL + 'graphicNovel/getAllLettering', data);
        return response.data;
    } catch (error) {
        console.log('ERROR IN FETCHING API')
    }
...
export const keywordImageUpdate = async (data) => {
    try {
        const response = await axios.post(BASE_URL + 'keyword/updateKeywordThumbnail', data);
        return response.data;
    } catch (error) {
        logouter();
    }
