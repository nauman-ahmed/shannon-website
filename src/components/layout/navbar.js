    ...
    <div>
      ...
      <div className='fullViewNavbar'>
        <div className="filterhomebox v2">
          <Link to="/illustration-artists" className={"filterhomelink v2 " + (props.aciveBtn === "illustration-artists" || props.curreCate == "Illustration" || props.curreCate == "Illustration-artists" ? "w--current" : "")}>ILLUSTRATION</Link>
          {/* <a href="http://localhost:3001/" target="_blank" className={"filterhomelink v2 "+(props.aciveBtn === "kidshannon"?"w--current":"")}>KIDSHANNON</a> */}
          <a href="https://kidshannon.com" target="_blank" className={"filterhomelink v2 " + (props.aciveBtn === "kidshannon" ? "w--current" : "")} onClick={()=>localStorageAddToCart()}>KIDSHANNON</a>
          <Link to="/photography" className={"filterhomelink v2 " + (props.aciveBtn === "photography" || props.curreCate == "Photography" ? "w--current" : "")}>PHOTOGRAPHY</Link>
          <div className='navbarBipocLink'>
            ...
            <Link to="/bipoc" className={"filterhomelink v2 d-flex " + (props.aciveBtn === "bipoc" || localStorage.getItem("Bipoc") !== "none" ? "w--current" : "")}>BIPOC </Link>
          ...
          <Link to="/medical" className={"filterhomelink v2 " + (props.aciveBtn === "medical" || props.curreCate == "Medical" ? "w--current" : "")}>MEDICAL</Link>
          {/* <Link to="/cgi" className={"filterhomelink v2 " + (props.aciveBtn === "cgi" ? "w--current" : "")}>CGI</Link> */}
          <Link to="/motion" className={"filterhomelink v2 " + (props.aciveBtn === "motion" || props.curreCate == "Motion" ? "w--current" : "")}>MOTION</Link>
