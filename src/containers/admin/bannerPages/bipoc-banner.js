...
function BipocBanners(props) {
  ...
  <div className='px-xl-5 mx-xl-5 banners'>
    <div className='d-flex flex-column scrollerOn pt-2 mx-5'>
      ...
      <p className='mb-3'><b>BLACK ARTIST</b> ({banners.length>0?banners[1].aspectRatio.width+"X"+banners[1].aspectRatio.height:null})</p>
      <div className='d-flex mb-4'>
        ...
        <input ref={inputFileRef2} hidden onChange={(e)=>{props.uploadImage(e,banners.length>0?banners[1]._id:"")}} type="file"/>
      </div>
      <p className='mb-3'><b>ASIAN ARTIST</b> ({banners.length>0?banners[2].aspectRatio.width+"X"+banners[2].aspectRatio.height:null})</p>
      <div className='d-flex mb-4'>
        <div className='artistcardAdmin'>
        ...
        <input ref={inputFileRef3} hidden onChange={(e)=>{props.uploadImage(e,banners.length>0?banners[2]._id:"")}} type="file"/>
      </div>
      <p className='mb-3'><b>LATINO ARTIST</b> (({banners.length>0?banners[3].aspectRatio.width+"X"+banners[3].aspectRatio.height:null}))</p>
      <div className='d-flex mb-4'>
        <div className='artistcardAdmin half'>
        ...
        <input ref={inputFileRef4} hidden onChange={(e)=>{props.uploadImage(e,banners.length>0?banners[3]._id:"")}} type="file"/>
      </div>
      <p className='mb-3'><b>CENTRAL ASIAN ARTIST</b> (({banners.length>0?banners[4].aspectRatio.width+"X"+banners[4].aspectRatio.height:null}))</p>
      <div className='d-flex mb-4'>
        <div className='artistcardAdmin half'>
        ...
        <input ref={inputFileRef5} hidden onChange={(e)=>{props.uploadImage(e,banners.length>0?banners[4]._id:"")}} type="file"/>
      </div>
      <p className='mb-3'><b>INDIGENOUS ARTIST</b> (({banners.length>0?banners[5].aspectRatio.width+"X"+banners[5].aspectRatio.height:null}))</p>
      <div className='d-flex mb-4'>
        <div className='artistcardAdmin half'>
        ...
        <input ref={inputFileRef6} hidden onChange={(e)=>{props.uploadImage(e,banners.length>0?banners[5]._id:"")}} type="file"/>
      </div>
    </div>
  </div>
  )
