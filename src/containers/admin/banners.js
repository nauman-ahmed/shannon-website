...
function Banners(props) {
  ...
  <div className='px-xl-5 mx-xl-5 banners'>
    ...
    <div className='d-flex flex-column scrollerOn pt-2 mx-5'>
      <p className='mb-3'><b>BIPOC</b> (000X000)</p>
      ...
      <p className='mb-3'><b>KIDSHANNON</b> (000X000)</p>
      <div className='d-flex mb-4'>
      ...
      <p className='mb-3'><b>MEDICAL</b> (000X000)</p>
      <div className='d-flex mb-4'>
        <div className='artistcard'>
      ...
      <p className='mb-3'><b>NEWS</b> (000X000)</p>
      <div className='d-flex mb-4'>
        <div className='artistcard half'>
      ...
      <p className='mb-3'><b>MOTION</b> (000X000)</p>
      <div className='d-flex mb-4'>
        <div className='artistcard half'>
      ...
      <p className='mb-3'><b>ABOUT</b> (000X000)</p>
      <div className='d-flex mb-4'>
        <div className='artistcard half'>
